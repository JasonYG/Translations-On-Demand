...
# The target language
$language_file = fopen("language.txt", "r");
$target = fgets($language_file);
...
$url = 'https://www.googleapis.com/language/translate/v2?key=' . $apiKey . '&q=' . rawurlencode($translated_text) . '&target='.$target;
